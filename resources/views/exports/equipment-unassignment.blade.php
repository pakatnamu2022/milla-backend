@php
  function getBase64ImageUnassign($path) {
...
<div class="page">
  ...
  @php
    ...
    $logoUrl = getBase64ImageUnassign(config('companies.logos.' . $company . '.large', '/companies/gplargo.png'));
  @endphp
  <div class="page-header">
    <div class="header-inner">
      ...
      <div class="h-title">
        <div class="h-title-main">ACTA DE DEVOLUCIÓN DE EQUIPOS</div>
  ...
  <!-- ══ EQUIPOS DEVUELTOS ══ -->
  <div class="card">
    <div class="card-title">Equipos Devueltos</div>
    <table class="equipment-table">
      ...
      <tr>
        ...
        <th style="width:30%">Observación Devolución</th>
      </tr>
      </thead>
      <tbody>
  ...
  @if($assignment->observacion_unassign)
    <!-- ══ OBSERVACIONES ══ -->
    <div class="card">
      <div class="card-title">Observaciones de Devolución</div>
  ...
  <!-- ══ DECLARACIÓN ══ -->
  <div class="card">
    <div class="card-title">Declaración de Devolución</div>
    <div class="decl-section">
      <div class="decl-text">
        <p>Certifico que los equipos detallados en el presente documento han sido devueltos al área de TICs en la fecha
          indicada y en las condiciones descritas. Declaro haber entregado la totalidad de los equipos que me fueron
          asignados, quedando exento de toda responsabilidad sobre los mismos a partir de la fecha de devolución
          registrada en este documento.</p>
        <p>En caso de existir daños, faltantes o deterioro no declarado en el momento de la devolución, y que sean
          verificados posteriormente por el área de Sistemas, reconozco mi responsabilidad y autorizo se descuente el
          valor correspondiente de mis haberes, prestaciones sociales, vacaciones, indemnizaciones, bonificaciones y
          demás derechos que me correspondan. Con la firma del presente documento doy conformidad a la devolución
          realizada y libero a la empresa de cualquier reclamo posterior sobre los equipos aquí relacionados.</p>
      </div>
    </div>
  </div>
