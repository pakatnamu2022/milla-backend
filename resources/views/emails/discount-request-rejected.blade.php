            ...
            <td style="padding:24px;">
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%"
                ...
                <tr>
                  ...
                  <td
                    style="padding:12px 16px;font:600 14px/1.6 Inter,Arial,Helvetica,sans-serif;color:#6b7280;border-bottom:1px solid #e6e8ee;text-align:right;text-decoration:line-through;">
                    S/ {{ number_format($final_price, 2) }}
                  </td>
                </tr>
                <tr style="background:#fef2f2;">
                  <td colspan="2"
                      style="padding:12px 16px;font:600 14px/1.6 Inter,Arial,Helvetica,sans-serif;color:#991b1b;text-align:center;">
                    Solicitud Rechazada
                  </td>
                </tr>
                </tbody>
