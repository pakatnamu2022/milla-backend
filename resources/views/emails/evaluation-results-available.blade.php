...
@section('email_subject') Tu resultado de desempeño ya está disponible @endsection
@section('title') Tu resultado está disponible @endsection
@section('subtitle') {{ $evaluation_name }} @endsection
