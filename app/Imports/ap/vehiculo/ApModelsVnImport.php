  ...
  private function processRow(array $row, int $rowNumber): void
  {
    ...
    DB::transaction(function () use (
      ...
      ApModelsVn::create([
        ...
        'power'             => $row['potencia_hp'] ?? 0,
        'wheelbase'         => $row['distancia_entre_ejes_mm'] ?? 0,
        'axles_number'      => $row['n_de_ejes'] ?? 0,
        'width'             => $row['ancho_mm'] ?? 0,
        'length'            => $row['largo_mm'] ?? 0,
        'height'            => $row['alto_mm'] ?? 0,
        'seats_number'      => $row['n_de_asientos'] ?? 0,
        'doors_number'      => $row['n_de_puertas'] ?? 0,
        'net_weight'        => $row['peso_neto_kg'] ?? 0,
        'gross_weight'      => $row['peso_bruto_kg'] ?? 0,
        'payload'           => $row['carga_util_kg'] ?? 0,
        'displacement'      => $row['cilindrada_cc'] ?? 0,
        'cylinders_number'  => $row['n_de_cilindros'] ?? 0,
        'passengers_number' => $row['n_de_pasajeros'] ?? 0,
        'wheels_number'     => $row['n_de_ruedas'] ?? 0,
