...
use App\Http\Resources\ap\comercial\ApVehicleDocumentsResource;
...
class ApVehicleDocumentsService extends BaseService implements BaseServiceInterface
{
    public function list(Request $request)
    {
        return $this->getFilteredResults(
            ApVehicleDocuments::class,
            $request,
            ApVehicleDocuments::filters,
            ApVehicleDocuments::search,
            ApVehicleDocumentsResource::class,
            [
                'vehicleMovement',
                'transmitter',
                'receiver',
    ...
    {
        $document = ApVehicleDocuments::with([
            'vehicleMovement',
            'transmitter',
            'receiver',
            'transferModality',
    ...
    public function store(mixed $data)
    {
        return DB::transaction(function () use ($data) {
            ...
            $document = ApVehicleDocuments::create($documentData);

            // 4. Cargar relaciones y retornar
            return new ApVehicleDocumentsResource($document->load([
                'vehicleMovement',
                'transmitter',
                'receiver',
                'transferModality',
    ...
    {
        return new ApVehicleDocumentsResource($this->find($id));
    }
    ...
    public function update(mixed $data)
    {
        return DB::transaction(function () use ($data) {
            ...
            return new ApVehicleDocumentsResource($document->fresh()->load([
                'vehicleMovement',
                'transmitter',
                'receiver',
                'transferModality',
