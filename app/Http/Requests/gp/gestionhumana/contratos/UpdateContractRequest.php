...
class UpdateContractRequest extends FormRequest
{
  ...
  {
    return [
      'empleado_id'              => 'sometimes|required|integer|exists:rrhh_persona,id',
      'tipo_contrato_id'         => 'sometimes|required|integer|exists:rrhh_tipo_contrato,id',
      'template_contrato_id'     => 'sometimes|required|integer|exists:rrhh_plantilla_contrato,id',
      'sede_id'                  => 'sometimes|required|integer|exists:config_sede,id',
      'cargo_id'                 => 'sometimes|required|integer|exists:rrhh_cargo,id',
      'sueldo'                   => 'sometimes|required|numeric|min:0',
      'fecha_inicio_actividades' => 'nullable|date_format:Y-m-d',
      'fecha_inicio_contrato'    => 'sometimes|required|date_format:Y-m-d',
