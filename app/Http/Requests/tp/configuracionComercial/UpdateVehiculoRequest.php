...
class UpdateVehiculoRequest extends FormRequest
{
    ...
    {
        $id = $this->route('control_vehicle') ?? $this->id;
        ...
        return [
            ...
            'placa' => [
                ...
                'string',
                'max:20',
                Rule::unique('op_vehiculo', 'placa')->ignore($id)
            ],
            ...
            'ult_manteniento_realizado' => 'nullable|date',
            'km_mantenimiento' => 'nullable|numeric|min:0',
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'ult_manteniento_realizado.date' => 'La fecha de mantenimiento debe ser una fecha válida',
            'km_mantenimiento.numeric' => 'El KM de mantenimiento debe ser un número',
            'km_mantenimiento.min' => 'El KM de mantenimiento debe ser mayor o igual a 0',
        ];
    }
}