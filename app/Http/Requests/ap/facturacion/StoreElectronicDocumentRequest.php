...
class StoreElectronicDocumentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'ap_billing_document_type_id' => 'required|integer|exists:ap_billing_document_types,id',
            'serie' => 'required|string|size:4',
            'numero' => 'nullable|integer|min:1',

            // Tipo de operación
            'ap_billing_transaction_type_id' => 'required|integer|exists:ap_billing_transaction_types,id',
            ...
            // Datos del cliente
            'ap_billing_identity_document_type_id' => 'required|integer|exists:ap_billing_identity_document_types,id',
            ...
            // Moneda
            'ap_billing_currency_id' => 'required|integer|exists:ap_billing_currencies,id',
            ...
            'items.*.ap_billing_igv_type_id' => 'required|integer|exists:ap_billing_igv_types,id',
    ...
    {
        return [
            'ap_billing_document_type_id.required' => 'El tipo de documento es obligatorio',
    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            ...
            if (in_array($this->input('ap_billing_document_type_id'), [3, 4])) {
                ...
                if ($this->input('ap_billing_document_type_id') == 3 && !$this->has('ap_billing_credit_note_type_id')) {
                    $validator->errors()->add(
                ...
                if ($this->input('ap_billing_document_type_id') == 4 && !$this->has('ap_billing_debit_note_type_id')) {
                    $validator->errors()->add(
            ...
            if ($this->input('detraccion') === true) {
                if (!$this->has('ap_billing_detraction_type_id')) {
                    $validator->errors()->add(
