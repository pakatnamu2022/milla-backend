...
class StoreApVehicleInspectionRequest extends StoreRequest
{
  public function rules(): array
  {
    return [
      ...
      'photo_front' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:10240', // 5MB max
      'photo_back' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:10240', // 5MB max
      'photo_left' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:10240', // 5MB max
      'photo_right' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:10240', // 5MB max
      'photo_optional_1' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:10240', // 5MB max
      'photo_optional_2' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:10240', // 5MB max
      'photo_optional_3' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:10240', // 5MB max
      'photo_optional_4' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:10240', // 5MB max
      'photo_optional_5' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:10240', // 5MB max
      'photo_optional_6' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:10240', // 5MB max
      // Detalles de trabajo
