...
class StoreApAssignmentLeadershipRequest extends StoreRequest
{
  ...
  public function messages(): array
  {
    return [
      ...
      'boss_id.required' => 'El jefe de ventas es obligatorio.',
      'boss_id.exists' => 'El jefe de ventas no existe en la base de datos.',
