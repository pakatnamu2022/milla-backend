...
class StoreApVehicleColorRequest extends StoreRequest
{
  public function rules(): array
  {
    return [
      'codigo' => [
        ...
        'string',
        'max:50',
        Rule::unique('ap_color_vn', 'codigo')->whereNull('deleted_at'),
      ],
      'descripcion' => [
        'required',
        'string',
        'max:255',
        Rule::unique('ap_color_vn', 'descripcion')->whereNull('deleted_at'),
      ],
    ];
  }
