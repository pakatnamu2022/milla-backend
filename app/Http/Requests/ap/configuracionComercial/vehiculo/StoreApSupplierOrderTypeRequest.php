...
class StoreApSupplierOrderTypeRequest extends StoreRequest
{
  public function rules(): array
  {
    return [
      'codigo' => [
        ...
        'string',
        'max:50',
        Rule::unique('tipo_pedido', 'codigo')->whereNull('deleted_at'),
      ],
      'descripcion' => [
        'required',
        'string',
        'max:255',
        Rule::unique('tipo_pedido', 'descripcion')->whereNull('deleted_at'),
      ],
    ];
  }
