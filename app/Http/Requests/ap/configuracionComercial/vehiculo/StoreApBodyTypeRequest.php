...
class StoreApBodyTypeRequest extends StoreRequest
{
  public function rules(): array
  {
    return [
      'codigo' => [
        ...
        'string',
        'max:100',
        Rule::unique('ap_tipo_carroceria', 'codigo')->whereNull('deleted_at'),
      ],
      'descripcion' => [
        'required',
        'string',
        'max:255',
        Rule::unique('ap_tipo_carroceria', 'descripcion')->whereNull('deleted_at'),
      ],
    ];
  }
