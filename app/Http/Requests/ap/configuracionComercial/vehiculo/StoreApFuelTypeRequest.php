...
class StoreApFuelTypeRequest extends StoreRequest
{
    public function rules(): array
    {
        return [
            'codigo' => [
                ...
                'string',
                'max:100',
              Rule::unique('ap_tipo_combustible', 'codigo')->whereNull('deleted_at'),
            ],
            'descripcion' => [
                'required',
                'string',
                'max:255',
              Rule::unique('ap_tipo_combustible', 'descripcion')->whereNull('deleted_at'),
            ],
            'motor_electrico' => [
                'required',
                'boolean',
