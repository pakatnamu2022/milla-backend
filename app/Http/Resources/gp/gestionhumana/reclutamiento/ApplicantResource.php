...
class ApplicantResource extends JsonResource
{
  public function toArray(Request $request): array
  {
    return [
      ...
      'enfermedad_operacion_lesion' => $this->enfermedad_operacion_lesion,
      'verificativa_status'    => $this->verificativa_status,
      'observacion_verificativa' => $this->observacion_verificativa,
      'comentarios_reclutamiento' => $this->comentarios_reclutamiento,
