...
class RecruitmentProcessResource extends JsonResource
{
  public function toArray(Request $request): array
  {
    return [
      ...
      'solicitante'        => $this->whenLoaded('requester', fn() => $this->requester?->name),
      'prioridad'          => $this->prioridad?->value,
      'prioridad_label'    => $this->prioridad?->label(),
      ...
      'fecha_inicio_pausa' => $this->fecha_inicio_pausa?->format('Y-m-d H:i'),
      'dias_pausados'      => $this->dias_pausados,
      'veces_pausado'      => $this->veces_pausado,
