...
class ApModelsVnResource extends JsonResource
{
  public function toArray(Request $request): array
  {
    return [
      ...
      'costo_transporte' => $this->costo_transporte,
      'otros_importes' => $this->otros_importes,
      'descuento_compra' => $this->descuento_compra,
      'importe_igv' => $this->importe_igv,
      'total_compra_cigv' => $this->total_compra_cigv,
