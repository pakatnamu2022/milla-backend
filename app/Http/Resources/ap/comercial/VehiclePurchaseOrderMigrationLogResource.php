...
class VehiclePurchaseOrderMigrationLogResource extends JsonResource
{
  ...
  protected function getStepName(): string
  {
    return match ($this->step) {
      ...
      'asset_transaction' => 'Transacción de Activo',
      'asset_transaction_detail' => 'Detalle de Transacción de Activo',
      'asset_transaction_serial' => 'Serial de Transacción de Activo',
