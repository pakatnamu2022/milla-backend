...
class ShippingGuidesResource extends JsonResource
{
  public function toArray(Request $request): array
  {
    return [
      ...
      'transmitter_description' => ($this->transmitter && $this->transmitter->description) ? $this->transmitter->description . ' - ' . ($this->transmitter->address ?? '') : "",
      'receiver_description' => ($this->receiver && $this->receiver->description) ? $this->receiver->description . ' - ' . ($this->receiver->address ?? '') : "",
