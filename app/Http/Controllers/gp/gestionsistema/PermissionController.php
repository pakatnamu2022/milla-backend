...
class PermissionController extends Controller
{
     ...
     */
    public function assignMultipleToRole(Request $request)
    {
        try {
            $request->validate([
                'role_id' => 'required|exists:config_roles,id',
            ...
            $this->service->assignMultiplePermissionsToRole(
                $request->role_id,
                $request->permissions
            );

            return $this->success(['message' => 'Permisos asignados correctamente']);
        } catch (\Throwable $th) {
            return $this->error($th->getMessage());
        }
    }
     ...
     */
    public function syncToRole(Request $request)
    {
        try {
            $request->validate([
                'role_id' => 'required|exists:config_roles,id',
            ...
            return $this->success(['message' => 'Permisos sincronizados correctamente']);
        } catch (\Throwable $th) {
            return $this->error($th->getMessage());
        }
    }
