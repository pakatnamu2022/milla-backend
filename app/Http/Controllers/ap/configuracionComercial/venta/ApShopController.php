...
use App\Http\Requests\ap\configuracionComercial\venta\IndexApShopRequest;
...
{
  protected ApShopService $service;

  public function __construct(ApShopService $service)
  {
    $this->service = $service;
  }

  public function index(IndexApShopRequest $request)
  {
    try {
  ...
  public function store(StoreApShopRequest $request)
  {
    try {
  ...
  public function update(UpdateApShopRequest $request, $id)
  {
    try {
