...
class PurchaseReception extends BaseModel
{
    ...
    const filters = [
        'search' => ['reception_number', 'supplier_invoice_number', 'shipping_guide_number'],
        'purchase_order_id' => '=',
        'warehouse_id' => '=',
        'status' => '=',
        'reception_type' => '=',
    ...
    public function setSupplierInvoiceNumberAttribute($value)
    {
        $this->attributes['supplier_invoice_number'] = $value ? Str::upper(Str::ascii($value)) : null;
    }
    ...
    public function getHasRejectedItemsAttribute(): bool
    {
        return $this->details()->where('quantity_rejected', '>', 0)->exists();
    }
