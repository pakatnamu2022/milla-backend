...
Route::middleware(['auth:sanctum'])->group(callback: function () {
  ...
  Route::group(['prefix' => 'ap'], function () {
    ...
    Route::group(['prefix' => 'commercial'], function () {
      ...
      Route::post('purchaseRequestQuote/changeSede/{id}', [PurchaseRequestQuoteController::class, 'changeSede']);
      ...
      Route::prefix('reports')->group(function () {
        ...
        Route::get('vehicle-sale-status-audit', [ApVehicleSaleStatusAuditController::class, 'index']);
