...
class MejoraProcesosApSeeder extends Seeder
{
  ...
  private const HISTORIAS = [
    ...
    ['2027-09', 'Implementar IA para comprobación de teléfono e e-mail', '2026-10-31', 'alta', 'TICS', 'IA Verificación Contacto', 'recepcion'],
    ...
    ['2027-09', 'Implementar Reporte de Errores en email y teléfonos', '2026-10-31', 'alta', 'TICS', 'Reporte Errores Contacto', 'reportes'],
    ['2026-10', 'Implementar historial del cliente + vehículo', '2026-10-15', 'alta', 'TICS', 'Historial Cliente-Vehículo', 'recepcion'],
    ['2027-09', 'Implementar Protocolo de SMS y/o WA al cliente (apertura de OT)', '2026-11-30', 'alta', 'TICS', 'SMS/WA Apertura OT', 'recepcion'],
    ['2027-09', 'Implementar Protocolo de SMS y/o WA al cliente (trabajo de OT)', '2026-11-30', 'alta', 'TICS', 'SMS/WA Trabajo OT', 'taller'],
    ['2027-09', 'Implementar Protocolo de SMS y/o WA al cliente (control de calidad)', '2026-11-30', 'alta', 'TICS', 'SMS/WA Control Calidad', 'taller'],
    ['2027-09', 'Implementar Protocolo de SMS y/o WA al asesor a fin de preparar la salida del vehículo', '2026-11-30', 'alta', 'TICS', 'SMS/WA Salida Vehículo', 'entrega'],
    ['2027-09', 'Implementar integración de facturas por pagar con IA', '2027-02-28', 'media', 'TICS', 'IA Facturas por Pagar', 'back_office'],
    ...
    ['2026-09', 'Implementar Reportes por Sede en archivos independientes', '2026-11-30', 'alta', 'TICS', 'Reportes por Sede', 'reportes'],
