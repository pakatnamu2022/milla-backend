...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('ap_billing_electronic_documents', function (Blueprint $table) {
            ...
            // Tipo de comprobante
            $table->foreignId('ap_billing_document_type_id')->constrained('ap_billing_document_types');
            $table->string('serie', 4)->comment('Serie del comprobante (FFF1, BBB1, etc.)');
            $table->integer('numero')->comment('Número correlativo');

            // Tipo de operación
            $table->foreignId('ap_billing_transaction_type_id')->constrained('ap_billing_transaction_types');
            ...
            // Datos del cliente
            $table->foreignId('ap_billing_identity_document_type_id')->constrained('ap_billing_identity_document_types');
            ...
            $table->foreignId('ap_billing_detraction_type_id')->nullable()->constrained('ap_billing_detraction_types')->nullOnDelete();
            ...
            $table->foreignId('ap_billing_credit_note_type_id')->nullable()->constrained('ap_billing_credit_note_types')->nullOnDelete();
            $table->foreignId('ap_billing_debit_note_type_id')->nullable()->constrained('ap_billing_debit_note_types')->nullOnDelete();
            ...
            $table->index(['origin_module', 'origin_entity_type', 'origin_entity_id']);
            $table->index('fecha_de_emision');
            $table->index('status');
            $table->index('cliente_numero_de_documento');
        });

        // Tabla de items/líneas del comprobante
        Schema::create('ap_billing_electronic_document_items', function (Blueprint $table) {
            $table->id();
            $table->foreignId('ap_billing_electronic_document_id')->constrained('ap_billing_electronic_documents')->cascadeOnDelete();
            ...
            // IGV
            $table->foreignId('ap_billing_igv_type_id')->constrained('ap_billing_igv_types');
        ...
        Schema::create('ap_billing_nubefact_logs', function (Blueprint $table) {
            $table->id();
            $table->foreignId('ap_billing_electronic_document_id')->nullable()->constrained('ap_billing_electronic_documents')->cascadeOnDelete();
