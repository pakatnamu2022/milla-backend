...
return new class extends Migration {
  ...
  public function up(): void
  {
    Schema::table('ap_work_orders', function (Blueprint $table) {
      ...
      $table->dateTime('official_closing_date')->nullable()->comment("Fecha de cierra - emisión del comprobante final")->after('actual_delivery_date');
    });
  }
  ...
  public function down(): void
  {
    Schema::table('ap_work_orders', function (Blueprint $table) {
      ...
      $table->dropColumn('official_closing_date');
    });
  }
};
