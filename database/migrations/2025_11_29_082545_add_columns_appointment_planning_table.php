...
return new class extends Migration {
  ...
  public function up(): void
  {
    Schema::table('appointment_planning', function (Blueprint $table) {
      $table->foreignId('type_operation_appointment_id')->after('id')->constrained('ap_post_venta_masters')->onDelete('cascade');
      $table->foreignId('type_planning_id')->after('type_operation_appointment_id')->constrained('ap_post_venta_masters')->onDelete('cascade');
