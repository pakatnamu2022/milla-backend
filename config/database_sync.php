  ...
  'business_partners' => [
    ...
    'dbtp' => [
      ...
      'mapping' => [
        ...
        'TipoDocumento' => fn($data) => ApMasters::find($data['document_type_id'])?->code ?? '',
  ...
  'business_partners_ap_supplier' => [
    ...
    'dbtp' => [
      ...
      'mapping' => [
        ...
        'TipoDocumentoId' => fn($data) => substr(trim((string)(ApMasters::find($data['document_type_id'])?->code ?? '')), 0, 3),
