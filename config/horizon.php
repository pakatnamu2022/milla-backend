...
return [
  ...
  */
  ...
  'defaults' => [
    ...
    'supervisor-sg-migrate-venta'            => [
      'connection'          => 'redis',
      'queue'               => ['shipping_guides_comercial_venta'],
      'balance'             => 'auto',
      'autoScalingStrategy' => 'time',
      'minProcesses'        => 2,
      'maxProcesses'        => 6,
    ...
    'supervisor-sg-migrate-traslado'         => [
      'connection'          => 'redis',
      'queue'               => ['shipping_guides_comercial_traslado'],
      'balance'             => 'auto',
      'autoScalingStrategy' => 'time',
      'minProcesses'        => 2,
      'maxProcesses'        => 4,
    ...
    'supervisor-sg-migrate-compra'           => [
      'connection'          => 'redis',
      'queue'               => ['shipping_guides_comercial_compra'],
      'balance'             => 'auto',
      'autoScalingStrategy' => 'time',
      'minProcesses'        => 2,
      'maxProcesses'        => 4,
    ...
    'supervisor-sg-sync-venta'               => [
      'connection'          => 'redis',
      'queue'               => ['shipping_guide_sync_comercial_venta'],
      'balance'             => 'auto',
      'autoScalingStrategy' => 'time',
      'minProcesses'        => 2,
      'maxProcesses'        => 6,
    ...
    'supervisor-sg-sync-traslado'            => [
      'connection'          => 'redis',
      'queue'               => ['shipping_guide_sync_comercial_traslado'],
      'balance'             => 'auto',
      'autoScalingStrategy' => 'time',
      'minProcesses'        => 2,
      'maxProcesses'        => 4,
    ...
    'supervisor-sg-sync-compra'              => [
      'connection'          => 'redis',
      'queue'               => ['shipping_guide_sync_comercial_compra'],
      'balance'             => 'auto',
      'autoScalingStrategy' => 'time',
      'minProcesses'        => 2,
      'maxProcesses'        => 4,
    ...
    'supervisor-sg-sync-postventa'           => [
      'connection'          => 'redis',
      'queue'               => ['shipping_guide_sync_postventa'],
      'balance'             => 'auto',
      'autoScalingStrategy' => 'time',
      'minProcesses'        => 2,
      'maxProcesses'        => 4,
  ...
  'environments' => [
    'production' => [
      'supervisor-electronic-documents'        => ['minProcesses' => 1, 'maxProcesses' => 3],
      'supervisor-check-electronic-documents'  => ['minProcesses' => 1, 'maxProcesses' => 2],
      'supervisor-purchase-orders'             => ['minProcesses' => 1, 'maxProcesses' => 2],
      // migrate (VerifyAndMigrateShippingGuideJob)
      'supervisor-sg-migrate-venta'            => ['minProcesses' => 1, 'maxProcesses' => 3],
      'supervisor-sg-migrate-traslado'         => ['minProcesses' => 1, 'maxProcesses' => 2],
      'supervisor-sg-migrate-compra'           => ['minProcesses' => 1, 'maxProcesses' => 2],
      'supervisor-sg-migrate-default'          => ['minProcesses' => 1, 'maxProcesses' => 1],
      // sync (SyncShippingGuideDynamicsJob)
      'supervisor-sg-sync-venta'               => ['minProcesses' => 1, 'maxProcesses' => 2],
      'supervisor-sg-sync-traslado'            => ['minProcesses' => 1, 'maxProcesses' => 2],
      'supervisor-sg-sync-compra'              => ['minProcesses' => 1, 'maxProcesses' => 2],
      'supervisor-sg-sync-postventa'           => ['minProcesses' => 1, 'maxProcesses' => 2],
      'supervisor-sg-sync-default'             => ['minProcesses' => 1, 'maxProcesses' => 1],
      'supervisor-invoice-sync'                => ['minProcesses' => 1, 'maxProcesses' => 2],
      'supervisor-credit-note-sync'            => ['minProcesses' => 1, 'maxProcesses' => 2],
      'supervisor-images-inspections'          => ['minProcesses' => 1, 'maxProcesses' => 2],
      'supervisor-inventory-adjustments'       => ['minProcesses' => 1, 'maxProcesses' => 1],
      'supervisor-establishments'              => ['minProcesses' => 1, 'maxProcesses' => 1],
      'supervisor-mail'                        => ['minProcesses' => 1, 'maxProcesses' => 2],
      ...
      'supervisor-fac-invoice-sync'            => ['minProcesses' => 1, 'maxProcesses' => 2],
      'supervisor-receivable-accounts'         => ['minProcesses' => 1, 'maxProcesses' => 2],
      'supervisor-payable-accounts'            => ['minProcesses' => 1, 'maxProcesses' => 1],
    ...
    'local' => [
      ...
      'supervisor-sg-migrate-traslado'         => ['minProcesses' => 1, 'maxProcesses' => 1],
      'supervisor-sg-migrate-compra'           => ['minProcesses' => 1, 'maxProcesses' => 1],
      'supervisor-sg-migrate-default'          => ['minProcesses' => 1, 'maxProcesses' => 1],
      // sync (SyncShippingGuideDynamicsJob)
      'supervisor-sg-sync-venta'               => ['minProcesses' => 1, 'maxProcesses' => 2],
      'supervisor-sg-sync-traslado'            => ['minProcesses' => 1, 'maxProcesses' => 1],
      'supervisor-sg-sync-compra'              => ['minProcesses' => 1, 'maxProcesses' => 1],
      'supervisor-sg-sync-postventa'           => ['minProcesses' => 1, 'maxProcesses' => 1],
      'supervisor-sg-sync-default'             => ['minProcesses' => 1, 'maxProcesses' => 1],
