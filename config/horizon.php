  ...
  */
  ...
  'environments' => [
    'production' => [
      ...
      'supervisor-sg-migrate-traslado'         => ['minProcesses' => 2, 'maxProcesses' => 4],
      'supervisor-sg-migrate-compra'           => ['minProcesses' => 2, 'maxProcesses' => 4],
      'supervisor-sg-migrate-default'          => ['minProcesses' => 1, 'maxProcesses' => 2],
      // sync (SyncShippingGuideDynamicsJob)
      'supervisor-sg-sync-venta'               => ['minProcesses' => 2, 'maxProcesses' => 6],
      'supervisor-sg-sync-traslado'            => ['minProcesses' => 2, 'maxProcesses' => 4],
      'supervisor-sg-sync-compra'              => ['minProcesses' => 2, 'maxProcesses' => 4],
      'supervisor-sg-sync-postventa'           => ['minProcesses' => 2, 'maxProcesses' => 4],
      'supervisor-sg-sync-default'             => ['minProcesses' => 1, 'maxProcesses' => 2],
      ...
      'supervisor-payable-accounts'            => ['minProcesses' => 1, 'maxProcesses' => 2],
      ...
      'supervisor-internal-notes'              => ['minProcesses' => 2, 'maxProcesses' => 4],
    ],
